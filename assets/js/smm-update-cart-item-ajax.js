 ...
 $(document).ready(function(){
            ...
            $(".quantity input[name=quantity]").on('change', function(e) {
                ...
                if ($(this).val() % $(this).attr("min") != 0 ) {
                    ...
                    $(this).val(setprice);
                    show_error($(this).parent(".quantity"), "Value rest by multiple of " + $(this).attr("min"));
                    ...
                    //alert(setprice);
                        ...
                        if(setprice > $(this).attr("max"))
                        $(this).val($(this).attr("max"));
                        remove_error($(this).parent(".quantity"));
                 }
            });
            function show_error($field, $mesg) {
                        ...
                        $('<div class="error_msg" style="color:#f00"><p>' + $mesg + '</p></div>').insertBefore($field);
                    }}
