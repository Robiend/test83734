	...
	<div class="woocommerce_variable_attributes wc-metabox-content" style="display: none;">
		<div class="data">
			<p class="form-row form-row-first upload_image">
				<a href="#" class="upload_image_button tips <?php _e( $variation_object->get_image_id( 'edit' ) ? esc_attr__( 'remove', 'woocommerce' ) : esc_attr__( '', 'woocommerce' )) ?>" data-tip="<?php _e( $variation_object->get_image_id( 'edit' ) ? esc_attr__( 'Remove this image', 'woocommerce' ) : esc_attr__( 'Upload an image', 'woocommerce' )) ?>" rel="<?php _e( esc_attr( $variation_id )) ?>">
			...
			<p class="form-row form-row-full options">
				...
				<?php endif; ?>
                <label class="tips" data-tip="<?php esc_attr_e( 'Enable this option to enable smm api call', 'woocommerce' ); ?>">
						<?php esc_html_e( 'SMM SERVER API', 'woocommerce' ); 
  ...
  document.getElementById(cid).innerHTML = uid;
            ...
            <div class="options_group show_if_api smm-flex-container">
                 <div class="smm-flex-item-1">
			            ...
			            <div> 
			            <label for="var_smapi_service_id_option_<?php echo esc_attr( $loop ); ?>""><?php _e( 'SMM API SERVICE', 'smm-api' ); ?></label>
			            </div>
                        ...
                        <?php 
                            printf( $api_item_list_options_output);
                        ?>
                        </select>  
                        <div>
                        <span id="var_smapi_service_span_option_<?php echo esc_attr( $loop ); ?>" style="float:left;display:block;"><?php 
                      printf( $descrption_opted_data ) ?></span>
                        </div>
                </div> 
                
                <div class="smm-flex-item-2">
                        <div>
                            <label for="_var_smapi_server_name_option_<?php echo esc_attr( $loop ); ?>"><?php _e( 'SERVER NAME', 'smm-api' ); ?></label>
                        </div>
                    ...
                    <select id="var_smapi_server_name_option_<?php echo esc_attr( $loop ); ?>" name="var_smapi_server_name_option[<?php echo esc_attr( $loop ); ?>]" class="var_smapi_server_name_option_<?php echo esc_attr( $loop ); ?>"  style="width: 300px;float:left;">
                            <?php 
                            printf( $api_server_list_options_output);
                            ?>
                    </select>
                    <div>
                ...
                <input  type="radio" id="product_input_box" name = "locate_input_box[<?php printf( esc_attr( $loop )) ?>]" value="product" <?php printf( $input_text_box_radio_product)?> >Use Custom Field at Product Page
                <input  type="radio" id="checkout_input_box" name = "locate_input_box[<?php printf( esc_attr( $loop )) ?>]" value="other" <?php printf( $input_text_box_radio_other)?> > Use field From Other Plugin
               </div>
                    </div></div>
                    <?php
