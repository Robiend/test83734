 ...
 *
 * @package    WordPress
 * @subpackage Softnwords Themes
 * @author     Softnwords Themes Team <info@softnwords.com>
 *
...
if ( ! class_exists( 'SMM_Gradients' ) ) {
    ...
    class SMM_Gradients {
        ...
        public function the_gradient( $role, $direction ) {
            _e( $this->get_gradient( $role, $direction ));
        }
        ...
        public function getModel( $class ) {
            return SMM_Registry::get_instance()->$class;
        }
        ...
        public function __get( $name ) {
            if ( $name == 'request' ) {
                if ( ! $this->_request instanceof SMM_Request ) {
                    $this->_request = SMM_Registry::get_instance()->request;
                }
