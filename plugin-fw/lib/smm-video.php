    ...
    class SMM_Video {
        ...
        public static function youtube( $args = array() ) {
            ...
            <div class="post_video youtube">
                <iframe wmode="transparent" width="<?php esc_html_e( $width); ?>" height="<?php esc_html_e($height); ?>" src="https://www.youtube.com/embed/<?php _e( $id) ?>?wmode=transparent" frameborder="0" allowfullscreen></iframe>
            </div>

            <?php
            $html = apply_filters( 'smm_video_youtube', ob_get_clean() );
        ...
        public static function vimeo( $args = array() ) {
            ...
            <div class="post_video vimeo">
                <iframe wmode="transparent" src="<?php esc_html_e($http);?>://player.vimeo.com/video/<?php esc_html_e( $id); ?>?title=0&amp;byline=0&amp;portrait=0" width="<?php _e($width) ?>" height="<?php _e( $height) ?>" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
            </div>

            <?php
            $html = apply_filters( 'smm_video_vimeo', ob_get_clean() );
