...
if ( !class_exists( 'SMM_Plugin_Panel_WooCommerce' ) ) {
    ...
    class SMM_Plugin_Panel_WooCommerce extends SMM_Plugin_Panel {
        ...
        public function woocommerce_update_options() {
            ...
            if ( isset( $_POST[ 'smm_panel_wc_options_nonce' ] ) && wp_verify_nonce( $_POST[ 'smm_panel_wc_options_nonce' ], 'smm_panel_wc_options_' . $this->settings[ 'page' ] ) ) {
                ...
                do_action( 'smm_panel_wc_after_update' );
                       ...
                       && isset( $_POST[ 'smms_wc_reset_options_nonce' ] ) && wp_verify_nonce( $_POST[ 'smms_wc_reset_options_nonce' ], 'smms_wc_reset_options_' . $this->settings[ 'page' ] )
            ) {
        ...
        public function admin_enqueue_scripts() {
            ...
            if ( 'admin.php' === $pagenow && strpos( get_current_screen()->id, $this->settings[ 'page' ] ) !== false ) {
                ...
                wp_localize_script( 'woocommerce_settings', 'woocommerce_settings_params', array(
                    'i18n_nav_warning' => __( 'The changes you have made will be lost if you leave this page.', 'smms-plugin-fw' )
                ) );
