    ...
    class SMM_Plugin_SubPanel extends SMM_Plugin_Panel {
        ...
        public function add_setting_page() {
            ...
            if ( !isset( $admin_page_hooks[ 'smms_plugin_panel' ] ) ) {
                ...
                add_menu_page( 'smms_plugin_panel', 'SMMS', 'nosuchcapability', 'smms_plugin_panel', null, $logo, $position );
                ...
                <div class="<?php _e ($panel_content_class) ?>">
                    ...
                    <?php if ( $this->is_show_form() ) : ?>
                        <form id="smms-plugin-fw-panel" method="post" action="options.php">
                            ...
                            <input type="hidden" name="<?php _e( $this->get_name_field( 'current_tab' )) ?>" value="<?php _e( esc_attr( $current_tab )) ?>"/>
