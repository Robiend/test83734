...
if ( !class_exists( 'SMM_Metabox' ) ) {
     ...
     * <code>
     * $args1 = array(
     *      'label'    => __( 'Metabox Label', 'smms-plugin-fw' ),
     ...
     *                          'fields' => array(
     *                          'meta_checkbox' => array(
     *                                 'label'    => __( 'Show title', 'smms-plugin-fw' ),
     *                                 'desc'     => __( 'Choose whether to show title of the page or not.', 'smms-plugin-fw' ),
     *                                 'type'     => 'checkbox',
     *                                 'private'  => false,
     *                                 'std'      => '1'),
     *                            ),
    ...
    class SMM_Metabox {
        ...
        public function save_postdata( $post_id ) {
            ...
            if ( !isset( $_POST[ 'smm_metaboxes_nonce' ] ) || !wp_verify_nonce( $_POST[ 'smm_metaboxes_nonce' ], 'metaboxes-fields-nonce' ) ) {
                return $post_id;
            }
	    ...
	    public function save_toggle_element() {
		    ...
		    if ( !isset( $_REQUEST[ 'smm_metaboxes_nonce' ] ) || !wp_verify_nonce( $_REQUEST[ 'smm_metaboxes_nonce' ], 'metaboxes-fields-nonce' ) ) {
			    return;
		    }
