	...
	class SMMS_System_Status {
		...
		public function __construct() {
			...
			$this->_settings = array(
				...
				'page_title'  => __( 'System Status', 'smms-plugin-fw' ),
				'menu_title'  => __( 'System Status', 'smms-plugin-fw' ) . $error_notice,
				'capability'  => 'manage_options',
				'page'        => $this->_page,
			);

			$this->_requirement_labels = array(
				'min_wp_version'    => __( 'WordPress Version', 'smms-plugin-fw' ),
				'min_wc_version'    => __( 'WooCommerce Version', 'smms-plugin-fw' ),
				'wp_memory_limit'   => __( 'Available Memory', 'smms-plugin-fw' ),
				'min_php_version'   => __( 'PHP Version', 'smms-plugin-fw' ),
				'min_tls_version'   => __( 'TLS Version', 'smms-plugin-fw' ),
				'wp_cron_enabled'   => __( 'WordPress Cron', 'smms-plugin-fw' ),
				'simplexml_enabled' => __( 'SimpleXML', 'smms-plugin-fw' ),
				'mbstring_enabled'  => __( 'MultiByte String', 'smms-plugin-fw' ),
				'imagick_version'   => __( 'ImageMagick Version', 'smms-plugin-fw' ),
				'gd_enabled'        => __( 'GD Library', 'smms-plugin-fw' ),
				'opcache_enabled'   => __( 'OPCache Save Comments', 'smms-plugin-fw' ),
				'url_fopen_enabled' => __( 'URL FOpen', 'smms-plugin-fw' ),
			);
		...
		public function check_system_status() {
			...
			if ( '' == get_option( 'smms_system_info' ) || ( isset( $_GET['page'] ) && $_GET['page'] == $this->_page ) ) {
				...
				$this->add_requirements( __( 'SMMS Plugins', 'smms-plugin-fw' ), array( 'min_wp_version' => '4.9', 'min_wc_version' => '3.4', 'min_php_version' => '5.6.20' ) );
				$this->add_requirements( __( 'WooCommerce', 'smms-plugin-fw' ), array( 'wp_memory_limit' => '64M' ) );
		...
		public function activate_system_notice() {
			...
			if ( true === $show_notice ) :
                ...
                <div id="smms-system-alert" class="notice notice-error is-dismissible" style="position: relative;">
                    <p>
                        <span class="smms-logo"><img src="<?php _e( smms_plugin_fw_get_default_logo())?>" /></span>
                        <b><?php _e( 'Warning!', 'smms-plugin-fw' ) ?></b><br />
						<?php _e( sprintf( __( 'The system check has detected some compatibility issues on your installation. %sClick here%s to know more', 'smms-plugin-fw' ), '<a href="' . esc_url( add_query_arg( array( 'page' => $this->_page ), admin_url( 'admin.php' ) ) ) . '">', '</a>' )) ?>
                    </p>
		...
		public function get_system_info() {
			...
			return apply_filters( 'smms_system_additional_check', array(
				...
				'min_wc_version'    => function_exists( 'WC' ) ? WC()->version : __( 'Not installed', 'smms-plugin-fw' ),
