...
if ( !function_exists( 'smm_pagination' ) ) {
    ...
    function smm_pagination( $pages = '', $range = 10 ) {
        ...
        _e( apply_filters( 'smm_pagination_html', $html ));
    }
}
...
if ( !function_exists( 'smms_plugin_fw_get_field' ) ) {
    ...
    function smms_plugin_fw_get_field( $field, $echo = false, $show_container = true ) {
        ...
        if ( $field_template ) {
            ...
            if ( $show_container ) _e( '<div class="smms-plugin-fw-field-wrapper smms-plugin-fw-' . $field[ 'type' ] . '-field-wrapper">');
...
if( ! function_exists( 'smms_plugin_fw_force_regenerate_plugin_update_transient' ) ){
	/**
	 ...
	 * @author sam softnwords
	 */
	function smms_plugin_fw_force_regenerate_plugin_update_transient() {
